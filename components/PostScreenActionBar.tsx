...
const PostScreenActionBar: React.FC<PostScreenActionBarProps> = ({ post }) => {
    ...
    return (
        <div className="md:hidden fixed bottom-0 left-0 right-0 bg-surface-2/95 backdrop-blur-sm border-t border-surface-3 h-20 px-4 flex items-center gap-4 z-30">
            <button
